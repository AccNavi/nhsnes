package kr.go.molit.nhsnes.receiver;
...
import kr.go.molit.nhsnes.util.serial.FTDriverUtil;
...
public class UsbReceiver extends BroadcastReceiver {
    ...
    private static final String ACTION_USB_PERMISSION = "com.covisoft.nhstestapp.USB_PERMISSION";
    ...
    public UsbReceiver(Context context, FTDriver serial) {
        mContext = context;
        mSerial = serial;
    }
...
//							public void run() {
//								((MainActivity)mActivity).showMessage("Usb is disconnected!");
//							}
//						});
                    }
                }

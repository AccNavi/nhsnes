...
//        dialog.show();
    ...
    public void onLocationChanged(final Location location) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                String eData = String.format(getResources().getString(R.string.n_data), location.getLongitude() + "");
                String nData = String.format(getResources().getString(R.string.e_data), location.getLatitude() + "");
                tvN.setText(nData);
                tvE.setText(eData);
            }
        });
